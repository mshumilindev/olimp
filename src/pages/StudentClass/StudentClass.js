...
function StudentClass({ user, classData, allCoursesList, usersList }) {
  ...
  function _renderCourse(course) {
    const currentSubject = allCoursesList?.find(
    ...
    return (
      <div className="studentClass__courses-item" key={course.course}>
        ...
        <div className="studentClass__courses-title">
          <Link
            to={"/courses/" + currentSubject?.id + "/" + currentCourse?.id}
            className="studentClass__courses-link"
          >
  ...
  function _renderUser(item) {
    return (
      <div className="studentClass__students-item" key={item.id}>
        <div
          className="studentClass__students-avatar"
          style={{ backgroundImage: "url(" + item.avatar + ")" }}
        >
          {!item.avatar ? <i className="fa fa-user" /> : null}
        </div>
