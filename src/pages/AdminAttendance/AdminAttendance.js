...
function AdminAttendance({
  ...
  const filterClassesList = useCallback(
    () =>
      orderBy(classesList, (v) =>
        v.title[lang] ? v.title[lang] : v.title["ua"],
      ).filter((classItem) =>
        selectedClass ? classItem.id === selectedClass : true,
      ),
    [classesList, lang, selectedClass],
  );
...
export default connect(
  mapStateToProps,
  mapDispatchToProps,
)(withFilters(AdminAttendance, null, null, null, null, "teacher", true, true));
