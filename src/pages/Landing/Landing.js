...
function Landing({ logo, siteName, address, usersList }) {
  ...
  return (
    <div className="landing">
      {!logo || !siteName || !address || !usersList || !usersList.length ? (
        <>
          <div
            className="landing__favicon"
        ...
        <DocumentTitle title={siteName[lang] ? siteName[lang] : siteName["ua"]}>
          <>
              ...
              <div className="landing__login">
                <Link to="/login">
                  <TextTooltip
                    ...
                    children={<i className="fas fa-key" />}
                  />
                </Link>
              </div>
            </div>
            ...
            <div className="landing__content">
              <div
                className="landing__block hasImage"
              ...
              >
                ...
                <p>
                  Платформа використовує сучасну технологію ReactJS останньої
                  версії, що дозволяє зробити сервіс швидким та легковісним.
                  Вона підтримується мобільними пристроями та працює в усіх
                  сучасних браузерах, тому не потребує ніяких додаткових
                  маніпуляцій з програмним забезпеченням.
                </p>
                <p>
                  Система захищена та закрита для загального доступу; кожен
                  користувач має свій унікальний профіль, який створюється
                  адміністрацією для запобігання втручанню у робочий процес
                  третіми особами.
                </p>
                <p>
                  Наша професійна IT команда швидкого реагування готова
                  виправити будь-які можливі нагальні проблеми, що дозволяє нам
                  надавати навчальні послуги безперервно і цілодобово. Цей
                  проект створений від початку і до кінця нашими спеціалістами
                  без використання вже реалізованих ідей, тому не має аналогів в
                  Україні.
                </p>
                <div
                  className="landing__scrollDown"
                  onClick={() => setViewport(1)}
                >
                  <TextTooltip
                    position="top"
                    text={translate("scroll_down")}
  ...
  function _renderNav() {
    return (
      <div
        className={classNames("landing__nav", { isWhite: currentScreen === 0 })}
      >
        {landingNav.map((item, index) => {
          return (
            <div
              className={classNames("landing__nav-item", {
  ...
  function _renderContact() {
    return (
      <div className="landing__address">
        <p>
          <i className="content_title-icon fas fa-map-marked-alt" />
          Проспект Правди 41д
        </p>
        <p>
          <i className="content_title-icon fas fa-mobile-alt" />
          <a href="tel:+380674406769">(067) 440 67 69</a>
        </p>
      </div>
    );
  }
    ...
    return (
      <div className="landing__social">
        <TextTooltip
          ...
          children={
            <a href="https://www.facebook.com/collegiumolimp" target="_blank">
              <div
                className="landing__social-item"
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
              >
        ...
        <TextTooltip
          ...
          children={
            <a
              href="https://www.instagram.com/olimp.collegium/"
              target="_blank"
            >
              <div
                className="landing__social-item"
        ...
        <div className="grid">
            ...
            <div className="landing__about-inner">
              <div className="landing__about-image-holder">
                <div
                  ...
                  style={{ backgroundImage: "url(" + about01 + ")" }}
                />
              </div>
              <div className="landing__about-heading">Реактивність</div>
          ...
          <div className="grid_col col-6 tablet-col-4">
            <div className="landing__about-inner">
              <div className="landing__about-image-holder">
                <div
                  className="landing__about-image"
                  style={{ backgroundImage: "url(" + about02 + ")" }}
                />
              </div>
              <div className="landing__about-heading">Мобільність</div>
              <div className="landing__about-text">
                <p>
                  Платформа підтримується мобільними пристроями та працює в усіх
                  сучасних браузерах, тому не потребує ніяких додаткових
                  маніпуляцій з програмним забезпеченням.
                </p>
          ...
          <div className="grid_col col-6 tablet-col-4">
            <div className="landing__about-inner">
              ...
              <div className="landing__about-heading">Інтерактивність</div>
              <div className="landing__about-text">
                <p>
                  Робочий процесс на платформі Колегіуму "Олімп" - це
                  інтерактивні відеоуроки; онлайн бібліотека з усіма навчальними
                  матеріалами; домашні завдання з тестовими запитаннями, творами
                  та вирішуванням математичних рівнянь &mdash; усе, що потрібно
                  учню для отримання максимально широкого спектру знань.
                </p>
              </div>
            </div>
          </div>
  ...
  function _renderUsers() {
    return (
      <div className="landing__users">
        ...
        >
          {orderBy(usersList, (v) => v.name)
            .filter((userItem) => userItem.role === "teacher")
            .map((userItem) => {
              return (
                <div className="landing__user" key={userItem.id}>
                  <div className="landing__user-avatar">
                    <div
                      className="landing__user-avatar-inner"
                      style={{
                        backgroundImage: "url(" + userItem.avatar + ")",
                      }}
                    >
  ...
  function _renderGallery() {
    return (
      <div className="landing__gallery">
        <div
          className="landing__gallery-container"
          style={{ backgroundImage: "url(" + galleryContainer + ")" }}
        >
          <div className="landing__gallery-slider">
            <div
              className="landing__gallery-slider-inner"
              style={{ transform: "translateX(-" + currentSlide + "00%)" }}
            >
              <div
                className="landing__gallery-slide"
                style={{ backgroundImage: "url(" + gallery01 + ")" }}
              />
              <div
                className="landing__gallery-slide"
                style={{ backgroundImage: "url(" + gallery02 + ")" }}
              />
              <div
                className="landing__gallery-slide"
                style={{ backgroundImage: "url(" + gallery03 + ")" }}
              />
              <div
                className="landing__gallery-slide"
                style={{ backgroundImage: "url(" + gallery04 + ")" }}
              />
              <div
                className="landing__gallery-slide"
                style={{ backgroundImage: "url(" + gallery05 + ")" }}
              />
              <div
                className="landing__gallery-slide"
                style={{ backgroundImage: "url(" + gallery06 + ")" }}
              />
            </div>
          </div>
          <div className="landing__gallery-actions">
            <span
              className="landing__gallery-action isPrev"
              onClick={() =>
                setCurrentSlide(
            ...
            >
              <TextTooltip
                position="top"
                text={translate("prev")}
                children={<i className="fas fa-chevron-left" />}
              />
            </span>
            <span
              className="landing__gallery-action isNext"
              onClick={() =>
                setCurrentSlide(
            ...
            >
              <TextTooltip
                position="top"
                text={translate("next")}
                children={<i className="fas fa-chevron-right" />}
              />
            </span>
          </div>
        </div>
  ...
  function handleScroll() {
    ...
    const increment = Math.round(
      parseFloat(scrollTop / windowHeight.toFixed(1)),
    );
...
const mapStateToProps = (state) => {
  return {
    ...
    siteName: state.siteSettingsReducer.siteSettingsList
      ...
      : null,
    address: state.siteSettingsReducer.siteSettingsList
      ? state.siteSettingsReducer.siteSettingsList.address
      : null,
