...
export default function ImageEditorTransform({transform, setSettingsItem}) {
                ...
                showDrop ?
                    <div className="imageEditor__transform-drop">
                        <div className="imageEditor__transform-rotate">
                            <div className="imageEditor__toolbar-heading">{ translate('rotate') }</div>
                            <div className="imageEditor__toolbar-btn" onClick={() => setSettingsItem('transform', {
                                ...transform,
                                rotate: {
                                    ...transform.rotate,
                        ...
                        <div className="imageEditor__transform-flip">
                            <div className="imageEditor__toolbar-heading">{ translate('flip') }</div>
                            <div className="imageEditor__toolbar-btn" onClick={() => setSettingsItem('transform', {
                                ...transform,
                                rotate: {
                                    ...transform.rotate,
                        ...
                        <div className="imageEditor__transform-skew">
                            <div className="imageEditor__toolbar-heading">{ translate('skew') }</div>
                            <div className="imageEditor__toolbar-btn">
                                <div className="imageEditor__toolbar-btn-icon-holder">
                                    <i className="substract" onClick={() => setSettingsItem('transform', {
                                        ...transform,
                                        skew: {
                                            ...transform.skew,
                                    ...
                                    <i className="add" onClick={() => setSettingsItem('transform', {
                                        ...transform,
                                        skew: {
                                            ...transform.skew,
                                            x: transform.skew.x - 10
    ...
    function closeDrop(e) {
        if ( e.target !== $transform.current && !$transform.current.contains(e.target) ) {
            setShowDrop(false);
        }
    }
}