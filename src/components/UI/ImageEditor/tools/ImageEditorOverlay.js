      ...
      >
        <i
          ...
          style={{
            color: overlay.color,
            textShadow:
              overlay.color === "#fff" || overlay.color === "#ffffff"
        ...
        <div className="imageEditor__overlay-drop">
          <div className="imageEditor__overlay-mode">
            <div className="imageEditor__toolbar-heading">
              {translate("blend_mode")}
            </div>
            <Form
              fields={modesFields}
              setFieldValue={(fieldID, value) =>
                setSettingsItem("overlay", { ...overlay, mode: value })
              }
            />
          </div>
          <div className="imageEditor__overlay-opacity">
            ...
            <Range
              ...
              type={"overlay"}
              setRange={(type, value) =>
                setSettingsItem(type, { ...overlay, opacity: value })
              }
            />
          </div>
          <div className="imageEditor__overlay-color">
            ...
            <SwatchesPicker
              color={overlay.color}
              onChange={(value) =>
                setSettingsItem("overlay", { ...overlay, color: value.hex })
              }
              height="100%"
              width={400}
            />
