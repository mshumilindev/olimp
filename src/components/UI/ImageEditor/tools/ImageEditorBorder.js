...
export default function ImageEditorBorder({ border, setSettingsItem }) {
  ...
  return (
    <div className="imageEditor__border" ref={$border}>
      ...
      >
        <i
          className="imageEditor__toolbar-btn-icon customIcon borderIcon"
          style={{
            border: "2px " + border.style + " " + border.color,
            boxShadow:
              border.color === "#fff" || border.color === "#ffffff"
                ? "inset 0 0 5px 0 rgba(0,0,0,.15), 0 0 5px 0 rgba(0,0,0,.25)"
                : "none",
          }}
        />
          ...
          <div className="imageEditor__border-col">
            <div className="imageEditor__border-style">
              ...
              <div
                ...
                onClick={() =>
                  setSettingsItem("border", { ...border, style: "solid" })
                }
              >
              ...
              <div
                className={classNames("imageEditor__toolbar-btn", {
                  active: border.style === "dashed",
                })}
                onClick={() =>
                  setSettingsItem("border", { ...border, style: "dashed" })
                }
              >
              ...
              <div
                className={classNames("imageEditor__toolbar-btn", {
                  active: border.style === "dotted",
                })}
                onClick={() =>
                  setSettingsItem("border", { ...border, style: "dotted" })
                }
              >
            ...
            <div className="imageEditor__border-width">
              ...
              <Range
                ...
                type={"border"}
                setRange={(type, value) =>
                  setSettingsItem(type, { ...border, width: value })
                }
                units={"px"}
              />
            </div>
          ...
          <div className="imageEditor__border-col">
            <div className="imageEditor__border-color">
              ...
              <SwatchesPicker
                color={border.color}
                onChange={(value) =>
                  setSettingsItem("border", { ...border, color: value.hex })
                }
                height="100%"
                width={400}
              />
