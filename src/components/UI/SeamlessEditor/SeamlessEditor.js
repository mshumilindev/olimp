...
export default function SeamlessEditor({
  loading,
  title,
  type,
  content,
  ...
  function _renderNoContent() {
    return (
      <div className="seamlessEditor__noContent">
        <span
          className="seamlessEditor__noContent-btn btn btn_primary"
  ...
  function _renderToolbar() {
    return (
      <div className="seamlessEditor__toolbar">
        <span
          className="seamlessEditor__toolbar-btn btn btn_primary round btn__xs"
          onClick={() => setIsEdited(!isEdited)}
        >
          <i className="fa fa-pencil-alt" />
        </span>
        <span
          className="seamlessEditor__toolbar-btn btn btn__error round btn__xs"
  ...
  function setBlock(block) {
    ...
    const index = newContent.indexOf(
      newContent.find((item) => item.id === block.id),
    );
  ...
  function scrollToBlock(blockID) {
    ...
    const container = document.querySelector(
      ".seamlessEditor__editor-blocks-holder .scrollbar__content",
    );
