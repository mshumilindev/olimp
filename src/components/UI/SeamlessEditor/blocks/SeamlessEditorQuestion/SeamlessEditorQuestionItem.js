...
export default function SeamlessEditorQuestionItem({
  item,
  index,
  handleChange,
  removeAnswer,
  ...
  return (
    <div className="seamlessEditor__editor-block-question-answer">
      <a
        href="/"
        className="seamlessEditor__editor-block-question-answer-remove"
        tabIndex="-1"
        onClick={(e) => removeAnswer(e, index)}
      >
        <i className="content_title-icon fa fa-minus-circle" />
      </a>
      <div className="seamlessEditor__editor-block-question-answer-num">
        {index + 1})
      </div>
      <Form
        fields={formFields}
