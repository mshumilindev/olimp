    ...
    <div className="chalkBoard__actions">
            ...
            children={
              <span
                className={classNames("btn btn_primary round", {
                  inactive: activeBoard !== "text",
                })}
                onClick={switchBoard("text")}
              >
        ...
        <div className="chalkBoard__actionsItem">
          <TextTooltip
            ...
            children={
              <span
                className={classNames("btn btn_primary round", {
                  inactive: activeBoard !== "drawing",
                })}
                onClick={switchBoard("drawing")}
              >
      ...
      <div className="chalkBoard__actions-row">
        <div className="chalkBoard__actionsItem">
          <TextTooltip
            position="left"
            text={translate("close_chalkboard")}
            children={
              <span
                className="btn btn_primary round"
                onClick={() => toggleChalkBoard(chat.id, false)}
              >
