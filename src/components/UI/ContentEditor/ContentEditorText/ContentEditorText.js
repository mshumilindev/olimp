...
export default function ContentEditorText({
  block,
  setBlock,
  removeBlock,
  noBtns,
  ...
  const editorToolbar = toolbar || [
    "fullscreen undo redo | formatselect | forecolor | fontselect | fontsizeselect | numlist bullist | align | bold italic underline strikeThrough subscript superscript | image",
  ];
