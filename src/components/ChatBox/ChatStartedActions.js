    ...
    <div className="chatroom__btnsHolder">
      {currentChatOrganizer ? (
        <TextTooltip
          position="top"
          text={
            !isRecording ? translate("record") : translate("stop_recording")
          }
          children={
            <span
      ...
      <TextTooltip
        ...
        text={
          !muteChat
            ...
            : translate("unmute_microphone")
        }
        children={
          <span
            className={classNames("btn btn_primary round", {
              btn__pale: muteChat,
            })}
      ...
      {user.id === chat.organizer ? (
        <>
          ...
          {chat.chalkBoardOpen ? (
            <TextTooltip
              position="top"
              text={translate("virtual_chalkboard")}
              children={
                <span
                  className={classNames("btn round", {
        ...
        <TextTooltip
          position="top"
          text={raiseHand ? "Опустити руку" : "Підняти руку"}
          children={
            <span
              className={classNames("btn btn_primary round", {
                btn__success: raiseHand,
              })}
      ...
      {!isFullScreen && !isChatPage ? (
        <TextTooltip
          position="top"
          text={translate("change_size")}
          children={
            <span
              className="btn btn_primary round"
      ...
      {currentChatOrganizer ? (
        <span className="btn btn__error round" onClick={stopChat}>
