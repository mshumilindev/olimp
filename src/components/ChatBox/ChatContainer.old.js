...
const ChatContainer = ({user, chat, usersList, setIsFullScreen, setIsHidden, muteChat, shareScreen, setShareScreen, setUsersLength, onDisplayNameChange, noVideo, setApiRef, logo}) => {
  return (
