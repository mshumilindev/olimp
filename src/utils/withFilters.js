  ...
  return (props) => {
    ...
    return (
      <WrappedComponent
        ...
        showOnlyMy={!!showOnlyMy && showOnlyMyChecked ? showOnlyMy : null}
        selectedClass={selectedClass}
        setSelectedClass={setSelectedClass}
        filterByDate={{
          start: filterByDateFields[0].value,
          end: moment(filterByDateFields[0].value * 1000)
            .add(6, "d")
            .unix(),
        }}
      />
    ...
    function _renderFilters() {
      return (
        <Filters
          ...
          filterBy={
            JSON.parse(filterBy).length ? JSON.parse(filterBy) : undefined
          }
